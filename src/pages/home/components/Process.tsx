...
const steps = [
  {
    ...
    week: "Week 1 — 2",
    summary:
      "We audit your infrastructure, data landscape, and business objectives. Technical discovery sessions with your engineers to map the real constraints.",
    deliverables: ["Architecture audit", "Data assessment", "Feasibility report", "ROI model"],
    icon: "ri-search-line",
    image:
  ...
  },
  {
    ...
    week: "Week 3 — 4",
    summary:
      "We design the system architecture, select the right models and infrastructure stack, and define APIs, schemas, and deployment pipelines.",
    deliverables: ["System design", "API spec", "Model selection", "Infra blueprint"],
  ...
  },
  {
    ...
    week: "Week 5 — 10",
    summary:
      "Sprints in shared repos. CI/CD from day one. We build, test, and iterate with your team in daily standups and weekly demos.",
    deliverables: ["MVP system", "Test suite", "CI/CD pipeline", "Documentation"],
  ...
  },
  {
    ...
    week: "Week 11 — 12",
    summary:
      "Production rollout with monitoring, observability, and runbooks. We train your team and stay on-call for the first 90 days.",
    deliverables: ["Production deploy", "Monitoring stack", "Runbooks", "90-day support"],
          ...
          <div>
            <div className="flex items-center gap-2 mb-5">
              ...
              <span className="text-[11px] font-mono-tech tracking-[0.18em] text-neutral-500 uppercase">
                Services · A 12-week delivery cycle
              </span>
            </div>
            <h2 className="font-serif-display text-[44px] md:text-[64px] lg:text-[76px] leading-[0.98] tracking-[-0.03em] text-balance">
              Build fast,
              <br />
              <span className="italic text-neutral-400">ship right.</span>
            </h2>
          </div>
          <div className="max-w-sm">
            <p className="text-[14px] md:text-[15px] leading-[1.65] text-neutral-600">
              Every engagement follows a four-phase delivery model — rigorous on architecture,
              flexible on scope. Tap a phase to see what ships inside.
            </p>
          </div>
        </div>
                  ...
                  <div className="flex items-center gap-5 px-5 md:px-7 py-5">
                    ...
                    <div
                      className={`w-11 h-11 flex items-center justify-center rounded-full transition-colors ${
                        isActive ? "bg-accent-500" : "bg-neutral-100"
                      }`}
                    >
                      <i className={`${s.icon} text-lg ${isActive ? "text-neutral-900" : "text-neutral-700"}`}></i>
                    </div>
                    ...
                    <i
                      className={`ri-arrow-down-s-line text-xl transition-transform ${
                        isActive ? "rotate-180 text-accent-400" : "text-neutral-400 group-hover:text-neutral-700"
                      }`}
                    ></i>
                  </div>
                ...
                <div className="flex items-end justify-between gap-4">
                  <div>
                    <div className="text-[11px] font-mono-tech tracking-wider text-white/65 uppercase">
                      Phase · {steps[active].no} / 04
                    </div>
                    <div className="mt-1 font-serif-display text-[26px] md:text-[30px] text-white leading-tight">
                      {steps[active].title}
                    </div>
                  </div>
                  <div className="w-12 h-12 flex items-center justify-center rounded-full border border-accent-400/30 backdrop-blur-md bg-accent-500/20">
                    <i className={`${steps[active].icon} text-lg text-accent-400`}></i>
                  </div>
                </div>
              </div>
                ...
                {steps.map((s, i) => (
                  <span
                    ...
                    className={`flex-1 h-1 rounded-full transition-colors ${
                      i <= active ? "bg-accent-400" : "bg-white/25"
                    }`}
                  ></span>
                ))}
              </div>
